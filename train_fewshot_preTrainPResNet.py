...
def train(args):
    ...
    pretrained_dict_feat = {k.split("backbone.")[1]: v for k, v in
                        torch.load('/root/loca/pre_models/rtdetr_r50vd_2x_coco_objects365_from_paddle.pth')['ema'][
...
if __name__ == '__main__':
    ...
    args.batch_size = 4
    #enc_layers: 
    args.num_enc_layers = 3 #待测试 【没有作用】。
    args.model_path = '/root/loca/output/RT_test/PResNet_1hyEnc_frozenBbone_bs4'
