...
def sinkhorn_tensorized(α, x, β, y, p=2, blur=.05, reach=None, diameter=None, scaling=.5, cost=None, 
    ...
    B, N, D = x.shape #torch.Size([1, 221184, 2])
    _, M, _ = y.shape #torch.Size([1, 12, 2])
    ...
    #torch.Size([1, 221184, 12]), torch.Size([1, 12, 221184])
    ...
    a_x, b_y, a_y, b_x = sinkhorn_loop( softmin_tensorized, 
                                        ...
                                        C_xx, C_yy, C_xy, C_yx, ε_s, ρ, debias=debias ) # None,None,[1, 12, 1], [1, 221184, 1]
